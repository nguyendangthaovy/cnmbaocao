...
const conversationRouter = (io) => {
    ...
    router.post('/:id/managers', conversationController.addManagersForConversation);
    router.delete('/:id/managers', conversationController.deleteManagersForConversation);
    return router;
};
